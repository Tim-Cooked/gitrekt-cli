...
from gitrekt_cli.soul.agent import BuiltinSystemPromptArgs
from gitrekt_cli.soul.approval import Approval
from gitrekt_cli.tools.display import DisplayBlock
from gitrekt_cli.tools.file import FileActions
from gitrekt_cli.tools.file.utils import build_diff_blocks
from gitrekt_cli.tools.utils import ToolRejectedError, load_desc
from gitrekt_cli.utils.path import is_within_directory
...
class WriteFile(CallableTool2[Params]):
    ...
    def __init__(self, builtin_args: BuiltinSystemPromptArgs, approval: Approval):
        super().__init__()
        self._work_dir = builtin_args.GITREKT_WORK_DIR
