...
from gitrekt_cli.tools.file.utils import MEDIA_SNIFF_BYTES, FileType, detect_file_type
from gitrekt_cli.tools.utils import load_desc_jinja, truncate_line
...
class ReadFile(CallableTool2[Params]):
    ...
    def __init__(self, runtime: Runtime) -> None:
        ...
        self._work_dir = runtime.builtin_args.GITREKT_WORK_DIR
