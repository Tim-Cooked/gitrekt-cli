...
from gitrekt_cli.soul import MaxStepsReached, get_wire_or_none, run_soul
...
from gitrekt_cli.tools.utils import load_desc
...
class Task(CallableTool2[Params]):
    ...
    async def _run_subagent(self, agent: Agent, prompt: str) -> ToolReturnValue:
        ...
        soul = GitrektSoul(agent, context=context)
