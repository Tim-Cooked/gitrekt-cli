...
def _collect_info() -> InfoData:
    from gitrekt_cli.agentspec import SUPPORTED_AGENT_SPEC_VERSIONS
    from gitrekt_cli.ui.wire.protocol import WIRE_PROTOCOL_VERSION

    return {
        "gitrekt_cli_version": VERSION,
...
def _emit_info(json_output: bool) -> None:
    ...
    lines = [
        f"gitrekt-cli version: {info['gitrekt_cli_version']}",
