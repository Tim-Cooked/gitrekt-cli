...
from gitrekt_cli.tools import extract_key_argument
from gitrekt_cli.ui.shell.console import console
from gitrekt_cli.ui.shell.keyboard import KeyEvent, listen_for_keyboard
from gitrekt_cli.utils.aioqueue import QueueShutDown
from gitrekt_cli.utils.message import message_stringify
from gitrekt_cli.utils.rich.columns import BulletColumns
from gitrekt_cli.utils.rich.markdown import Markdown
from gitrekt_cli.wire import WireUISide
...
class _ApprovalRequestPanel:
    def __init__(self, request: ApprovalRequest):
        ...
        self.options: list[tuple[str, ApprovalRequest.Response]] = [
            ...
            ("Reject, tell Gitrekt CLI what to do instead", "reject"),
        ]
