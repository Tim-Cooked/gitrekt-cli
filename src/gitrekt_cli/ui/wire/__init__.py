...
from gitrekt_cli.utils.aioqueue import Queue, QueueShutDown
from gitrekt_cli.utils.logging import logger
from gitrekt_cli.wire import Wire
from gitrekt_cli.wire.types import ApprovalRequest, Request
    ...
    async def _handle_prompt(
        ...
        try:
            await run_soul(
                ...
                self._cancel_event,
                self._soul.wire_file if isinstance(self._soul, GitrektSoul) else None,
            )
