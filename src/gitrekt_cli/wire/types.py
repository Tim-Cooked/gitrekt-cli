...
from gitrekt_cli.tools.display import DiffDisplayBlock, TodoDisplayBlock, TodoDisplayItem
from gitrekt_cli.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `gitrekt_cli.soul.approval.Request`, but
