...
_GITREKT_ANSI_THEME_NAME = "gitrekt-ansi"
_GITREKT_ANSI_THEME = ANSISyntaxTheme(
    {
...
def _resolve_code_theme(theme: str) -> str | SyntaxTheme:
    if theme.lower() == _GITREKT_ANSI_THEME_NAME:
        return _GITREKT_ANSI_THEME
    return theme
...
class MarkdownContext:
    ...
    def __init__(
        ...
        inline_code_theme: str | SyntaxTheme = _GITREKT_ANSI_THEME_NAME,
    ) -> None:
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks. Defaults to "gitrekt-ansi".
    ...
    def __init__(
        self,
        markup: str,
        code_theme: str = _GITREKT_ANSI_THEME_NAME,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--code-theme",
        dest="code_theme",
        default=_GITREKT_ANSI_THEME_NAME,
        help='code theme (pygments name or "gitrekt-ansi")',
    )
    parser.add_argument(
        "-i",
        "--inline-code-lexer",
